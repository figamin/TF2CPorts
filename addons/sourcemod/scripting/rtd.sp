...
new String:g_strTeamColors[][] = {"\x07B2B2B2", "\x07B2B2B2", "\x07FF4040", "\x0799CCFF", "\x0799FF99", "\x07FFFF00", "\x0799CCFF", "\x0799CCFF"};
...
{
	name = "TF2C: Roll the Dice",
	author = "linux_lover (abkowald@gmail.com), port by FigMan57",
