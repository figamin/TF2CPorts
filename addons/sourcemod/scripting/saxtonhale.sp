...
public Plugin:myinfo = {
	name = "VS Saxton Hale TF2C",
	author = "Rainbolt Dash, FlaminSarge, port by FigMan57",
...
public Action:Timer_Announce(Handle:hTimer)
{
	...
	if (Announce > 1.0 && Enabled2)
	{
		switch (announcecount)
		{
			...
			case 3:
			{
				CPrintToChatAll("{default}===VS Saxton Hale v.%s by {olive}Rainbolt Dash{default}, {olive}FlaminSarge{default}, Port by{olive} FigMan57{default}===", haleversiontitles[maxversion]);
			}
			case 5:
			{
				announcecount = 0;
