...
public Event_PlayerClass(Handle:event, const String:name[], bool:dontBroadcast)
{
    ...
    if(!IsValidClass(iClient, iClass))
    {
        ...
        PrintCenterText(iClient, "%s%s%s%s%s", "It's Red ", ClassNames[g_iRedClass], " vs Blue ", ClassNames[g_iBlueClass], " vs Green ", ClassNames[g_iGreenClass], " vs Yellow ", ClassNames[g_iYellowClass]);   
        PrintToChat(iClient, "%s%s%s%s%s", "It's Red ", ClassNames[g_iRedClass], " vs Blue ", ClassNames[g_iBlueClass], " vs Green ", ClassNames[g_iGreenClass], " vs Yellow ", ClassNames[g_iYellowClass]);
...
PrintStatus() {
    ...
    PrintCenterTextAll("%s%s%s%s%s%s%s%s", "This is Class Warfare: Red ", ClassNames[g_iRedClass], " vs Blue ", ClassNames[g_iBlueClass], " vs Green ", ClassNames[g_iGreenClass], " vs Yellow ", ClassNames[g_iYellowClass]);
    PrintToChatAll("%s%s%s%s%s%s%s%s", "This is Class Warfare: Red ", ClassNames[g_iRedClass], " vs Blue ", ClassNames[g_iBlueClass], " vs Green ", ClassNames[g_iGreenClass], " vs Yellow ", ClassNames[g_iYellowClass]);
}
...
SetupClassRestrictions() {
    ...
    g_iBlueClass = Math_GetRandomInt(TF_CLASS_SCOUT, TF_CLASS_CIVILIAN);
    g_iRedClass = Math_GetRandomInt(TF_CLASS_SCOUT, TF_CLASS_CIVILIAN);
    g_iGreenClass = Math_GetRandomInt(TF_CLASS_SCOUT, TF_CLASS_CIVILIAN);
    g_iYellowClass = Math_GetRandomInt(TF_CLASS_SCOUT, TF_CLASS_CIVILIAN);
...
{
    SetupClassRestrictions();
    PrintToChatAll("%s%s%s%s%s%s%s%s", "Mid Round Class Change: Red ", ClassNames[g_iRedClass], " vs Blue ", ClassNames[g_iBlueClass], ClassNames[g_iBlueClass], " vs Green ", ClassNames[g_iGreenClass], " vs Yellow ", ClassNames[g_iYellowClass]);
}
